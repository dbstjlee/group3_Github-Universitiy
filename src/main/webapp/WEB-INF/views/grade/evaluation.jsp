...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/evaluation.css">
</head>
<body>
	<div>
		<h1>강의 평가</h1>
	...
	<form action="${pageContext.request.contextPath}/evaluation" method="post">
		<ul>
			...
			<li><input type="radio" name="answer1" value="3" id="a13"> <label for="a13"> 보통이다</label></li>
		...
		<ul>
			...
			<li><input type="radio" name="answer2" value="3" id="a23"> <label for="a23"> 보통이다</label></li>
		...
		<ul>
			...
			<li><input type="radio" name="answer3" value="3" id="a33"> <label for="a33"> 보통이다</label></li>
		...
		<ul>
			...
			<li><input type="radio" name="answer4" value="3" id="a43"> <label for="a43"> 보통이다</label></li>
		...
		<ul>
			...
			<li><input type="radio" name="answer5" value="3" id="a53"> <label for="a53"> 보통이다</label></li>
		...
		<ul>
			...
			<li><input type="radio" name="answer6" value="3" id="a63"> <label for="a63"> 보통이다</label></li>
		...
		<ul>
			...
			<li><input type="radio" name="answer7" value="3" id="a73"> <label for="a73"> 보통이다</label></li>
