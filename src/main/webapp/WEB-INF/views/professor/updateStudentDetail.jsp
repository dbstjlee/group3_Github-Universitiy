...
<div class="d-flex justify-content-center align-items-start" style="min-width: 100em;">
	...
	<main>
		...
		<br>
		<form action="/professor/student" method="post">
			...
			<table class="form--table">
				<tr>
					...
					<td>
						<input type="number" name="absent" id="absent">
					</td>
					<td>
						<span style="color: #888">※ 결석 5회 이상시 F학점입니다.</span>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="number" name="lateness" id="lateness">
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td>
						<input type="number" name="midExam" id="midExam">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="number" name="finalExam" id="finalExam">
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="number" name="convertedMark" id="convertedMark">
					</td>
				</tr>
				<tr>
					<td>
