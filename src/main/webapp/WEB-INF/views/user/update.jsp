					...
					<table class="update--table">
						<tbody>
							<tr>
								...
								<td><input type="text" name="address" id="address" class="input--box" value="${studentInfo.address}"></td>
							</tr>
							<tr>
								<td><label for="tel">전화번호</label></td>
								<td><input type="text" name="tel" id="tel" class="input--box" value="${studentInfo.tel}"></td>
							</tr>
							<tr>
								<td><label for="email">이메일</label></td>
								<td><input type="text" name="email" id="email" class="input--box" value="${studentInfo.email}"></td>
							</tr>
							<tr>
				...
				<c:when test="${principal.userRole == 'staff'}">
					...
					<table class="update--table">
						<tbody>
							<tr>
								<td><label for="address">주소</label></td>
								<td><input type="text" name="address" id="address" class="input--box" value="${staffInfo.address}"></td>
							</tr>
							<tr>
								<td><label for="tel">전화번호</label></td>
								<td><input type="text" name="tel" id="tel" class="input--box" value="${staffInfo.tel}"></td>
							</tr>
							<tr>
								<td><label for="email">이메일</label></td>
								<td><input type="text" name="email" id="email" class="input--box" value="${staffInfo.email}"></td>
							</tr>
							<tr>
								<td><label for="password">비밀번호 확인</label></td>
								<td><input type="password" name="password" id="password" class="input--box"></td>
