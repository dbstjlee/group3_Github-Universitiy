		...
		<main>
			...
			<div class="d-flex justify-content-between align-items-start" style="margin-bottom: 50px;">
				<div class="sub--filter">
					<form action="${pageContext.request.contextPath}/sugang/application/search" method="get">
						...
						<tbody>
							<c:forEach var="sugangItem" items="${sugangList}">
								<tr>
									...
									<td class="sub--list--name">${sugangItem.professorName}</td>
					...
					<div class="page--list">
						<c:forEach begin="1" end="${totalPages}" var="i">
							<c:choose>
								...
								<c:otherwise>
									<span><a href="${pageContext.request.contextPath}/sugang/applicationSearch?page=${i}">${i}</a></span>
								</c:otherwise>
							</c:choose>
						</c:forEach>
					</div>
